...
/**
 * API response schema for updating an asset
 * @export
...
/**
 * Check if a given object implements the AssetUpdateResponse interface.
 */
export function instanceOfAssetUpdateResponse(value: object): value is AssetUpdateResponse {
...
export function AssetUpdateResponseFromJSON(json: any): AssetUpdateResponse {
    return AssetUpdateResponseFromJSONTyped(json, false);
}

export function AssetUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetUpdateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AssetUpdateResponseToJSON(json: any): AssetUpdateResponse {
    return AssetUpdateResponseToJSONTyped(json, false);
}

export function AssetUpdateResponseToJSONTyped(value?: AssetUpdateResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
